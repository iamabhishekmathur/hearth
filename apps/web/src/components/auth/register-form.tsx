...
export function RegisterForm({ onSubmit, onSwitchToLogin }: RegisterFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        <label htmlFor="name" className="block text-sm font-medium text-hearth-text">
          Name
        </label>
        <input
          id="name"
      ...
      <div>
        <label htmlFor="reg-email" className="block text-sm font-medium text-hearth-text">
          Email
        </label>
        <input
          id="reg-email"
      ...
      <div>
        <label htmlFor="reg-password" className="block text-sm font-medium text-hearth-text">
          Password
        </label>
        <input
          id="reg-password"
