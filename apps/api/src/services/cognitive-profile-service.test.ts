...
describe('extractCognitivePatterns', () => {
  ...
  it('skips extraction when session is too short', async () => {
    ...
    vi.mocked(prisma.chatMessage.findMany).mockResolvedValue([
      { id: 'm1', orgId: 'org-1', sessionId: 'sess-1', role: 'user', content: 'hello', metadata: {}, createdBy: null, respondingToMessageId: null, producedTaskIds: [], createdAt: new Date() },
      { id: 'm2', orgId: 'org-1', sessionId: 'sess-1', role: 'assistant', content: 'hi there', metadata: {}, createdBy: null, respondingToMessageId: null, producedTaskIds: [], createdAt: new Date() },
    ]);
